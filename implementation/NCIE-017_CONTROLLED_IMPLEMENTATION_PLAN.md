...
| WBS-16 Security, IAM & Governance | IN PROGRESS — WP-001 THROUGH WP-010 LOCALLY WORK COMPLETE; WP-010 SOURCE RELEASE AUTHORIZED / PENDING | WP-010 implemented under `...-036` and release authorized under `...-037`; no WBS-16 closure decision exists | Preserve zero grants/capabilities and exact test-state separation; require the separate final Human closure decision. |
