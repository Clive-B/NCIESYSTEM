...
| WBS-16 Security, IAM & Governance | IN PROGRESS — WP-001 THROUGH WP-008 WORK COMPLETE / LOCALLY VERIFIED / CONTROLLED SOURCE RELEASED | WP-008 architecture approved under `...-029`, implementation released under `...-030`, and source release authorized under `...-031` | Preserve zero grants/capabilities and exclusions; begin no WP-009 or later implementation without separate architecture and implementation decisions. |
