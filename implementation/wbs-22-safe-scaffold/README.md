...
The scaffold deliberately has no external packages, branded visual values, breakpoint assumptions, institutional navigation labels, live data, or authoritative state. `fixtures/workspace-shell.html` is test input only. Its mock labels must remain visible.
